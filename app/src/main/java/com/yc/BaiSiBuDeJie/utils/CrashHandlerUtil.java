...
public class CrashHandlerUtil implements UncaughtExceptionHandler {
    ...
    private boolean handleException(Throwable ex) {
        ...
        LogTools.i("test-filename",saveCrashInfo2File(ex));
        return true;
    }
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        try {
            ...
            String path = Dir.getCrashDir();
            File file = FileUtil.createFile(path + fileName);
            LogTools.i("test-file",file.getPath()+","+ file.exists());
            FileUtil.writeToFile(file, sb.toString(),false);
